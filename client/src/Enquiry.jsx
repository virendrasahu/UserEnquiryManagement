...
export default function Enquiry() {
  ...
  const getAllEnquiry = () => {
    axios.get(`https://userenquirymanagement.onrender.com/api/enquiry/list`)
      .then(res => {
  ...
  let saveEnquiry = (e) => {
    ...
    if (formData._id) {
      axios.put(`https://userenquirymanagement.onrender.com/api/enquiry/update/${formData._id}`, formData)
        .then(() => {
       ...
       axios.post(`https://userenquirymanagement.onrender.com/api/enquiry/insert`, formData)
      .then((res) => {
